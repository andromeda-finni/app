...
void main() {
  group('Tugriki game logic and math', () {
    ...
    test('Variant 2 sum: 4 + 2 + 3 = 9 tugriks -> 18 coins', () {
      final totalTugriki =
          MarketCatalog.soup.priceTugriki +
    ...
    test('Variant 3 budget calculation: 20 coins limit', () {
      ...
      final totalTugriki = selection.fold<int>(
        0,
        (sum, g) => sum + g.priceTugriki,
      );
      final totalCoins = totalTugriki * kExchangeRate;
    ...
    test('Variant 3 budget overflow detection', () {
      ...
      final totalTugriki = allItems.fold<int>(
        0,
        (sum, g) => sum + g.priceTugriki,
      );
      final totalCoins = totalTugriki * kExchangeRate;
  ...
  group('Tugriki widgets tests', () {
    testWidgets('TugrikiRateVisualizer renders exchange rate', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: TugrikiRateVisualizer(compact: true)),
        ),
      );
      await tester.pump();
    ...
    testWidgets(
      'TugrikiCellBreakdown interactive filling to 12 coins formula',
      (tester) async {
        var retried = false;
        ...
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
              body: TugrikiCellBreakdown(onRetry: () => retried = true),
            ),
          ),
        );
        await tester.pump();
