...
const questMapNodes = <QuestMapNodeData>[
  ...
  QuestMapNodeData(
    ...
    description:
        'Пересчитывай цены по курсу и планируй покупки в другой валюте.',
    emoji: '🪙',
    x: 0.28,
    y: 515,
  ...
  QuestMapNodeData(
    ...
    description:
        'Помоги Барсуку собрать средства и увидь, как растёт общий проект.',
    emoji: '🌳',
    x: 0.70,
    y: 250,
  ),
