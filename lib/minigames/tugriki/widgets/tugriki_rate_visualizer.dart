  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.crimson.withValues(alpha: 0.4), width: 2),
        boxShadow: const [
          BoxShadow(
          ...
          Row(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Column(
                  children: [
                    Icon(Icons.swap_horiz_rounded, size: 36, color: AppColors.crimson),
                    Text(
                      'равны',
                      style: TextStyle(
                        fontFamily: AppFonts.family,
