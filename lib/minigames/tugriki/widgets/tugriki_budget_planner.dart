...
class TugrikiBudgetPlanner extends StatefulWidget {
  const TugrikiBudgetPlanner({super.key, required this.onComplete});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
        decoration: BoxDecoration(
          color: isSelected ? AppColors.parchmentDark : AppColors.cardBg,
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
        ...
        child: Row(
          children: [
            ...
            Text(good.iconEmoji, style: const TextStyle(fontSize: 24)),
